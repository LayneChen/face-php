 ...
 * 注册接口请求
 *
 * Generated from protobuf message <code>face_recog_package.FaceServRegisterRequest</code>
 */
class FaceServRegisterRequest extends \Google\Protobuf\Internal\Message
{
    /**
