...
class FaceServDetectResult extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type int $ret_code
     *           返回码， 成功为0,其他为非0
     *     @type \Face\DetResult[]|\Google\Protobuf\Internal\RepeatedField $ret_dets
     *           检测到的一个或者多人人脸
     *     @type string $userID
     *            用户ID
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .face_recog_package.DetResult ret_dets = 3;</code>
     * @param \Face\DetResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRetDets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Face\DetResult::class);
        $this->ret_dets = $arr;
